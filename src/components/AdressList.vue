      ...
      <div>
        ...
        <div class="clearfix">
          ...
          >
            ...
            <div>
              <a class="adress-text-default" v-if="o.isDefault">Default adress</a>
              <a class="adress-text" v-if="!o.isDefault" @click="setDefault(o.addressId)">Set default</a>
              <i class="el-icon-delete adress-icon" @click="delAddress(o.addressId)"></i>
            </div>
          </el-card>
